...
import { AVATAR_FRAMES, calculateLevel, getXPForNextLevel } from '../data/constants';
import { StorageService } from '../services/storage';
import { AvatarFrame } from './AvatarFrame';
import { Trophy, Award, Shield, CheckCircle2, Lock, Info, Edit3 } from 'lucide-react';
...
export const GamificationView: React.FC<GamificationViewProps> = ({
  ...
  const xpInfo = getXPForNextLevel(currentUser.xp);
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          {onOpenProfileEdit && (
            <button
              ...
              className="my-1 bg-white/20 hover:bg-white/30 border border-white/30 text-white font-bold px-3.5 py-1.5 rounded-2xl text-xs flex items-center gap-1.5 transition-all active:scale-95 shadow-sm"
            >
              <Edit3 className="w-3.5 h-3.5" />
              <span>Profil & Foto bearbeiten</span>
            </button>
          )}
